...
**dash** · he/they · [@da5ch0](https://github.com/da5ch0)
...
| repo | what it is |
|------|-----------|
| [expressiveness-vulnerability-identity](https://github.com/da5ch0/expressiveness-vulnerability-identity) | mathematical proof that natural language is inherently vulnerable — and that's what makes it powerful |
| [NeedingHelpIsArchitecture](https://github.com/da5ch0/NeedingHelpIsArchitecture) | reframing help-seeking for hackers, psychologists, and the stubbornly self-reliant |
| [Security_Gospel_per_DoD](https://github.com/da5ch0/Security_Gospel_per_DoD) | curated Rainbow Series — the DoD's own security canon, mirrored for practitioners |
...
<sub>*🐢🐢🐢🐢 — you know who the real enemy is.*</sub>
